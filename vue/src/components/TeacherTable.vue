  ...
  <div>
    <div class="teachertable">
      ...
      <el-table :data="tableData" height="400" border>
        ...
        <el-table-column prop="user" label="账号" width="150">
        </el-table-column>
      ...
      <el-button type="primary" @click="dialogAddVisible = true">新增教师</el-button>
    </div>
    ...
    <el-dialog title="新增教师" :visible.sync="dialogAddVisible">
      <el-form :model="add" :rules="rules" ref="add" label-width="100px" :inline="true" label-position="left">
        ...
        <el-form-item>
          <el-button type="primary" @click="addteacher('add')">新增教师</el-button>
    ...
    <el-dialog title="编辑教师" :visible.sync="dialogUpdateVisible">
      <el-form :model="update" ref="update" label-width="100px" :inline="true" label-position="left">
        ...
        <el-form-item>
          <el-button type="primary" @click="updateteacher('update')">更新教师</el-button>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
